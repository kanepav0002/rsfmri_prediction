function CBIG_preproc_censor_wrapper(BOLD_in, outlier_file, TR, BOLD_interm_out, BOLD_final_out, loose_mask, max_mem, repo_directory, low_f, high_f)
...
CBIG_dir=sprintf('%s/utils/CBIG-master', repo_directory);
fieldtrip_dir=sprintf('%s/utils/fieldtrip-master', repo_directory);
