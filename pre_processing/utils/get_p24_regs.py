...
motion_params=np.array(pd.read_csv('prep_motion_params.par', sep="\t", header=None, engine='python'))
...
if os.path.exists(args.gs_file):
    ...
    p24_p2_GS_regs=np.column_stack((p24_regs, WM, WM_d1, CSF, CSF_d1, GS, GS_d1))
    np.savetxt('p_24_2p_GS_regs.csv',p24_p2_GS_regs,delimiter=',')
...
if os.path.exists(args.dicer_file):
    ...
    p24_p2_Dic_regs=np.column_stack((p24_regs, WM, WM_d1, CSF, CSF_d1, dic, dic_d1))
    np.savetxt('p_24_2p_Dic_regs.csv',p24_p2_Dic_regs,delimiter=',')


p24_p2_regs=np.column_stack((p24_regs, WM, WM_d1, CSF, CSF_d1))
np.savetxt('p_24_2p_regs.csv',p24_p2_regs,delimiter=',')
np.savetxt('p_24_regs.csv',p24_regs,delimiter=',')
